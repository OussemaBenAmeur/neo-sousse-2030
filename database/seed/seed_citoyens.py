...
TUNISIAN_FIRST = ["Mohamed", "Ahmed", "Ali", "Fatma", "Nour", "Yasmine",
                   "Karim", "Sana", "Omar", "Leila", "Rami", "Amira", "Zied"]
TUNISIAN_LAST  = ["Ben Ali", "Trabelsi", "Mansour", "Chaabane", "Bouzid",
                   "Jebali", "Hamdi", "Sfaxi", "Nasr", "Khelifi", "Miled"]
...
def seed_citoyens():
    ...
    for i in range(100):
        ...
        email = f"{prenom.lower()}.{nom.lower().replace(' ', '')}{i}@neo-sousse.tn"
